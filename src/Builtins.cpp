...
static const std::unordered_map<Relation::BuiltinID, RelationInfo> builtinRelations = {
	...
	{RB::free,
	 {.name = "free",
	  .arity = RelArity::OneMany,
	  .locInfo = RelLocInfo::KeepsLoc,
	  .dom = {Predicate::createBuiltin(PB::FREE)},
	  .codom = {},
	  .genmc = {"???", "free"}}},
	{RB::retire,
	 {.name = "retire",
	  .arity = RelArity::OneMany,
	  .locInfo = RelLocInfo::KeepsLoc,
	  .dom = {Predicate::createBuiltin(PB::HPRET)},
	  .codom = {},
	  .genmc = {"???", "retire"}}},
...
static const DisjointPredSets disjointPredSets_ = {
	...
	/* NA, ATOM */
	{to_underlying(PB::NA), to_underlying(PB::ATOM)},
...
static const SubsetPredSets subsetPredSets_ = {
	{to_underlying(PB::RLX), {to_underlying(PB::ATOM)}},
	{to_underlying(PB::ACQ), {to_underlying(PB::ATOM)}},
	{to_underlying(PB::REL), {to_underlying(PB::ATOM)}},
	{to_underlying(PB::SC),
	 {to_underlying(PB::ATOM), to_underlying(PB::ACQ), to_underlying(PB::REL)}},
